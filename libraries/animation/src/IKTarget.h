...
public:
     ...
     *     <tr><td><code>2</code></td><td>HmdHead</td><td><span class="important">Deprecated: This target type is deprecated 
     *       and will be removed.</span><p>A special mode of IK that would attempt to prevent unnecessary bending of the 
     *       spine.</td></tr>
