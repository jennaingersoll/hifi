 ...
 *     bookmark.
 * @property {MyAvatar.AttachmentData[]} [attachments] - <span class="important">Deprecated: Use avatar entities instead.</span>
 *     <p>The attachments included with the bookmark.
 */
