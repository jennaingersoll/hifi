 ...
 *     The Oculus Store and Steam versions of Interface runs in limited commerce mode. <em>Read-only.</em>
 */
...
public:
     ...
     * {@link WalletScriptingInterface.ownershipVerificationFailed|ownershipVerificationFailed} signals.<p>
