You can create a music player that plays all your favorite tracks and also syncs the audio for other users in your domain. Using this tutorial, create a boombox to play music and an on/off button.
